...
| biomarker | ✅ | ⚠️ | N/A | 生物标志物状态；常见为阳性/阴性，如 positive/negative、1/0，也可能是高/低表达或突变型/野生型；目前为二分类变量，具体含义可以结合项目进行定义 |
...
| binary_y | ✅ | ✅ | N/A | 0/1编码 |
| cont_y | ✅ | ⚠️ | ⚠️ | 原型中为模拟数据，未明确实际含义与单位；模拟一个连续结局，但具体单位需要结合项目定义 |
