...
MODEL="$PACKAGE_DIR/models/continuous"
DATA="$PACKAGE_DIR/data/stan_input_continuous.json"
DRAWS="$PACKAGE_DIR/outputs/draws/continuous_draws.csv"
LOG="$PACKAGE_DIR/outputs/logs/continuous.log"
...
echo "Continuous draws written to $DRAWS"
