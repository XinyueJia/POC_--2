...
MODEL="$PACKAGE_DIR/models/survival"
DATA="$PACKAGE_DIR/data/stan_input_survival.json"
DRAWS="$PACKAGE_DIR/outputs/draws/survival_draws.csv"
LOG="$PACKAGE_DIR/outputs/logs/survival.log"
...
echo "Survival draws written to $DRAWS"
